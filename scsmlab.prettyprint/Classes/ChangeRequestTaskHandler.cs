...
{
    class ChangeRequestTaskHandler : ConsoleCommand
    {
            ...
            foreach (NavigationModelNodeBase node in nodes)
            {
                ...
                else
                {
                    ...
                    if (dataItemNode != null)
                    {
                        ...
                        dataItemWorkItem = ConsoleContextHelper.Instance.GetProjectionInstance((Guid)dataItemNode[Constants.WORKITEM_ID_DOLLAR], new Guid(Constants.CHANGEREQUEST_TYPEPROJECTION));
                    }
                }
                ...
                if (emg != null)
                {
                    ...
                    if ((this.emoAdminSetting[this.mpcAdminSetting, Constants.ADMINSETTING_CR_TEMPLATEPATH].Value == null || String.IsNullOrEmpty((String)this.emoAdminSetting[this.mpcAdminSetting, Constants.ADMINSETTING_CR_TEMPLATEPATH].Value)))
                    {
                    ...
                    else
                    {
                        ...
                        string strPath = this.emoAdminSetting[this.mpcAdminSetting, Constants.ADMINSETTING_CR_TEMPLATEPATH].Value as String;
