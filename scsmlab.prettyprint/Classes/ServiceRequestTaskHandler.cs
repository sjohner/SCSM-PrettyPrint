...
{
    class ServiceRequestTaskHandler : ConsoleCommand
    {
            ...
            foreach (NavigationModelNodeBase node in nodes)
            {
                ...
                else
                {
                    ...
                    if (dataItemNode != null)
                    {
                        ...
                        dataItemWorkItem = ConsoleContextHelper.Instance.GetProjectionInstance((Guid)dataItemNode[Constants.WORKITEM_ID_DOLLAR], new Guid(Constants.SERVICEREQUEST_TYPEPROJECTION));
                    }
                }
                ...
                if (emg != null)
                {
                    ...
                    if ((this.emoAdminSetting[this.mpcAdminSetting, Constants.ADMINSETTING_SR_TEMPLATEPATH].Value == null || String.IsNullOrEmpty((String)this.emoAdminSetting[this.mpcAdminSetting, Constants.ADMINSETTING_SR_TEMPLATEPATH].Value)))
                    {
                    ...
                    else
                    {
                        ...
                        string strPath = this.emoAdminSetting[this.mpcAdminSetting, Constants.ADMINSETTING_SR_TEMPLATEPATH].Value as String;
                        ...
                        for (int i = 1; i <= word.ActiveDocument.Bookmarks.Count; i++)
                        {
                            ...
                            if (dataItemClassProperties.ContainsKey(bookmarkName))
                            {
                                ...
                                if (dataItemWorkItem.HasProperty(bookmarkName) && dataItemWorkItem[bookmarkName] != null)
                                {
